...
import { AccountTransactionType, CcdAmount, ModuleReference, serializeUpdateContractParameters, toBuffer, type InstanceInfo, type UpdateContractPayload } from '@concordium/web-sdk';
